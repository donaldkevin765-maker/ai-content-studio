...
class WhisperSTT:
    ...
    def transcribe_to_srt(self, audio_path: str, output_path: str, language: str | None = None) -> str:
    ...
    async def atranscribe(self, audio_path: str, language: str | None = None) -> dict:
        import asyncio
        return await asyncio.to_thread(self.transcribe, audio_path, language)

    async def atranscribe_to_srt(self, audio_path: str, output_path: str, language: str | None = None) -> str:
        import asyncio
